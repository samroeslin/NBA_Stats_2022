...
#Players
Players <- c("Stephen Curry","James Harden","John Wall","Russell Westbrook","LeBron James","Kevin Durant","Paul George","Kawhi Leo0rd","Damian Lillard","Giannis Antetokounmpo")
...
KawhiLeo0rd_Salary <- c(2317532,3480647,18680395,19883125,20928455,24921719,34730093,36232632,39344900)
...
#Matrix
Salary <- rbind(StephenCurry_Salary, JamesHarden_Salary, JohnWall_Salary, RussellWestbrook_Salary, LeBronJames_Salary, KevinDurant_Salary, PaulGeorge_Salary, KawhiLeo0rd_Salary, DamianLillard_Salary, GiannisAntetokounmpo_Salary)
rm(StephenCurry_Salary, JamesHarden_Salary, JohnWall_Salary, RussellWestbrook_Salary, LeBronJames_Salary, KevinDurant_Salary, PaulGeorge_Salary, KawhiLeo0rd_Salary, DamianLillard_Salary, GiannisAntetokounmpo_Salary)
col0mes(Salary) <- Seasons
row0mes(Salary) <- Players


#Games (regular season)
StephenCurry_G <- c(78,80,79,79,51,69,5,63,64)
JamesHarden_G <- c(73,81,82,81,72,78,68,88,65)
JohnWall_G <- c(82,79,77,78,41,32,0,40,0)
RussellWestbrook_G <- c(46,67,80,81,80,73,57,65,78)
LeBronJames_G <- c(77,69,76,74,82,55,67,45,56)
KevinDurant_G <- c(81,27,72,62,68,78,0,35,55)
PaulGeorge_G <- c(80,6,81,75,79,77,48,54,31)
KawhiLeo0rd_G <- c(66,64,72,74,9,60,57,52,0)
DamianLillard_G <- c(82,82,75,75,73,80,66,67,29)
GiannisAntetokounmpo_G <- c(77,81,80,80,75,72,63,61,67)
#Matrix
Games <- rbind(StephenCurry_G,JamesHarden_G,JohnWall_G,RussellWestbrook_G,LeBronJames_G,KevinDurant_G,PaulGeorge_G,KawhiLeo0rd_G,DamianLillard_G,GiannisAntetokounmpo_G) #combine the vectors to create a matrix
rm(StephenCurry_G,JamesHarden_G,JohnWall_G,RussellWestbrook_G,LeBronJames_G,KevinDurant_G,PaulGeorge_G,KawhiLeo0rd_G,DamianLillard_G,GiannisAntetokounmpo_G) #remove individual vectors
col0mes(Games) <- Seasons
row0mes(Games) <- Players
...
JohnWall_MP <- c(36.3,35.9,36.2,36.4,34.4,34.5,0,32.2,0)
...
KevinDurant_MP <- c(38.5,33.8,35.8,33.4,34.2,34.6,0,33.1,37.2)
PaulGeorge_MP <- c(36.2,15.2,34.8,35.9,36.6,36.9,29.6,33.7,34.7)
KawhiLeo0rd_MP <- c(29.1,31.8,33.1,33.4,23.3,34,32.4,34.1,0)
...
#Matrix
MinutesPlayed <- rbind(StephenCurry_MP,JamesHarden_MP,JohnWall_MP,RussellWestbrook_MP,LeBronJames_MP,KevinDurant_MP,PaulGeorge_MP,KawhiLeo0rd_MP,DamianLillard_MP,GiannisAntetokounmpo_MP)
rm(StephenCurry_MP,JamesHarden_MP,JohnWall_MP,RussellWestbrook_MP,LeBronJames_MP,KevinDurant_MP,PaulGeorge_MP,KawhiLeo0rd_MP,DamianLillard_MP,GiannisAntetokounmpo_MP)
col0mes(MinutesPlayed) <- Seasons
row0mes(MinutesPlayed) <- Players


#Field Goals
StephenCurry_FG <- c(8.4,8.2,10.2,8.5,8.4,9.2,6.6,10.4,8.4)
JamesHarden_FG <- c(7.5,8,8.7,8.3,9,10.8,9.9,7.7,6.1)
JohnWall_FG <- c(7.1,6.6,7.4,8.3,6.8,7.7,0,7.3,0)
RussellWestbrook_FG <- c(7.5,9.4,8.2,10.2,9.5,8.6,10.6,8.4,7)
LeBronJames_FG <- c(10,9,9.7,9.9,10.5,10.1,9.6,9.4,11.4)
KevinDurant_FG <- c(10.5,8.8,9.7,8.9,9.3,9.2,0,9.3,10.5)
PaulGeorge_FG <- c(7.2,3,7.5,8.3,7.3,9.2,7.1,8.2,8.6)
KawhiLeo0rd_FG <- c(5.1,6.2,7.7,8.6,5.8,9.3,9.3,8.9,0)
DamianLillard_FG <- c(6.7,7.2,8.2,8.8,8.5,8.5,9.5,9,7.7)
GiannisAntetokounmpo_FG <- c()
#Matrix
FieldGoals <- rbind(StephenCurry_FG,JamesHarden_FG,JohnWall_FG,RussellWestbrook_FG,LeBronJames_FG,KevinDurant_FG,PaulGeorge_FG,KawhiLeo0rd_FG,DamianLillard_FG,GiannisAntetokounmpo_FG)
rm(StephenCurry_FG,JamesHarden_FG,JohnWall_FG,RussellWestbrook_FG,LeBronJames_FG,KevinDurant_FG,PaulGeorge_FG,KawhiLeo0rd_FG,DamianLillard_FG,GiannisAntetokounmpo_FG)
col0mes(FieldGoals) <- Seasons
row0mes(FieldGoals) <- Players
...
JohnWall_FGA <- c(16.3,14.8,17.5,18.4,16.3,17.3,0,18.2,0)
...
KevinDurant_FGA <- c(20.8,17.3,19.2,16.5,18,17.7,0,17.2,20.3)
PaulGeorge_FGA <- c(17,8.2,17.9,18,17,21,16.3,17.6,20.5)
KawhiLeo0rd_FGA <- c(9.8,12.8,15.1,17.7,12.3,18.8,19.9,17.5,0)
...
#Matrix
FieldGoalAttempts <- rbind(StephenCurry_FGA,JamesHarden_FGA,JohnWall_FGA,RussellWestbrook_FGA,LeBronJames_FGA,KevinDurant_FGA,PaulGeorge_FGA,KawhiLeo0rd_FGA,DamianLillard_FGA,GiannisAntetokounmpo_FGA)
rm(StephenCurry_FGA,JamesHarden_FGA,JohnWall_FGA,RussellWestbrook_FGA,LeBronJames_FGA,KevinDurant_FGA,PaulGeorge_FGA,KawhiLeo0rd_FGA,DamianLillard_FGA,GiannisAntetokounmpo_FGA)
col0mes(FieldGoalAttempts) <- Seasons
row0mes(FieldGoalAttempts) <- Players
...
JohnWall_PTS <- c(19.3,17.6,19.9,23.1,19.4,20.7,0,20.6,0)
...
KevinDurant_PTS <- c(32,25.4,28.2,25.1,26.4,26,0,26.9,29.9)
PaulGeorge_PTS <- c(21.7,8.8,23.1,23.7,21.9,28,21.5,23.3,24.3)
KawhiLeo0rd_PTS <- c(12.8,16.5,21.2,25.5,16.2,26.6,27.1,24.8,0)
...
#Matrix
Points <- rbind(StephenCurry_PTS,JamesHarden_PTS,JohnWall_PTS,RussellWestbrook_PTS,LeBronJames_PTS,KevinDurant_PTS,PaulGeorge_PTS,KawhiLeo0rd_PTS,DamianLillard_PTS,GiannisAntetokounmpo_PTS)
rm(StephenCurry_PTS,JamesHarden_PTS,JohnWall_PTS,RussellWestbrook_PTS,LeBronJames_PTS,KevinDurant_PTS,PaulGeorge_PTS,KawhiLeo0rd_PTS,DamianLillard_PTS,GiannisAntetokounmpo_PTS)
col0mes(Points) <- Seasons
row0mes(Points) <- Players
...
KawhiLeo0rd_playingStats <- read.csv("Kawhi_Leo0rd-Stats-Regular_Season-2022-05-09.csv")
