...
KawhiLeonard_G <- c(66,64,72,74,9,60,57,52,0)
...
KawhiLeonard_MP <- c(29.1,31.8,33.1,33.4,23.3,34,32.4,34.1,0)
...
KawhiLeonard_FG <- c(5.1,6.2,7.7,8.6,5.8,9.3,9.3,8.9,0)
DamianLillard_FG <- c(6.7,7.2,8.2,8.8,8.5,8.5,9.5,9,7.7)
GiannisAntetokounmpo_FG <- c(2.2,4.7,6.4,8.2,9.9,10,10.9,10.3,10.3)
#Matrix
...
KawhiLeonard_FGA <- c(9.8,12.8,15.1,17.7,12.3,18.8,19.9,17.5,0)
DamianLillard_FGA <- c(15.9,16.6,19.7,19.8,19.4,19.2,20.4,19.9,19)
GiannisAntetokounmpo_FGA <- c(5.4,9.6,12.7,15.7,18.7,17.3,19.7,18,18.6)
#Matrix
...
KawhiLeonard_PTS <- c(12.8,16.5,21.2,25.5,16.2,26.6,27.1,24.8,0)
